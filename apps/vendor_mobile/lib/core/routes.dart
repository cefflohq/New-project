...
const routeSpecs = <VRoute, RouteSpec>{
  ...
  VRoute.profile: RouteSpec(
    route: VRoute.profile,
    id: 'V-42',
    title: 'Profile',
    parent: VRoute.settings,
    tab: NavTab.menu,
  ...
  VRoute.subscriptionCheckout: RouteSpec(
    route: VRoute.subscriptionCheckout,
    id: 'V-52',
    title: 'Checkout',
    parent: VRoute.choosePlan,
    tab: NavTab.menu,
  ),
  VRoute.paymentSuccess: RouteSpec(
    route: VRoute.paymentSuccess,
    id: 'V-53',
    title: 'Confirmation',
    parent: VRoute.subscriptionCheckout,
    tab: NavTab.menu,
  ),
  VRoute.subscriptionDetails: RouteSpec(
    route: VRoute.subscriptionDetails,
    id: 'V-54',
