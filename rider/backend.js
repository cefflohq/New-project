(function () {
  ...
  // Flow 2 Founder closure: delivery recovery/reassignment is Vendor-
  // authorized only (initiate_delivery_recovery no longer accepts a Rider
  // caller at all). The Rider's legitimate channel stays reportDeliveryIssue
  // above -- "report an issue / request assistance", never a self-service
  // ownership release. No Rider-side wrapper for initiate_delivery_recovery
  // exists in this file by design.
