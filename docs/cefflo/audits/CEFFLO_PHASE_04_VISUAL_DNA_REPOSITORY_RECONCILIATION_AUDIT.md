...
- Header/bottom nav: flat white/chrome color, 60px each, explicit comment *"no lime underline beneath the title."* *(Historical finding. Superseded by D-45: Vendor Mobile now uses the gradient-header system in `sot/12_EXPERIENCE_SYSTEM.md` §8.)*
