**Status:** SUPERSEDED / HISTORICAL (2026-09-14, D-37) — no longer the active Driver/Rider Flutter UI/UX screen-inventory authority. Replaced by `docs/cefflo/sot/13_DRIVER_FLUTTER_42_SCREEN_MASTER.md` (42 screens, D01–D42), supplied by the Founder as the sole active canonical Driver Flutter UI/UX master. This file is retained for traceability only — do not implement against it, do not cite it as current doctrine, and do not treat any of its screen IDs (`R-01`–`R-33`) as live routes going forward. See `docs/cefflo/05_DECISIONS.md` D-37 for the full reconciliation record.
**Status before supersession (preserved for context):** CANONICAL SOURCE ARTIFACT — merged into repo 2026-09-04. The master itself remained "Revised Working Master — Founder Review Required" (see its own status line below) — it was NOT YET IMPLEMENTED and NOT YET Founder-locked (its own Definition of Done checklist was unchecked, Founder Gates A-I were open). The current LIVE Rider client remains the PWA described in `docs/cefflo/07_RIDER.md`, consistent with `docs/cefflo/05_DECISIONS.md` D-13 stage-gating. This file never authorized Rider Flutter implementation to begin, and its supersession does not change that.
**Terminology note (2026-09-12, historical):** this target surface was named "Driver Product" in the five-canonical-product-surface freeze (`docs/cefflo/sot/02_ARCHITECTURE.md` §0). Surface/architecture naming only — the canonical "Rider" role/schema/API name was, and remains, unchanged. See `docs/cefflo/05_DECISIONS.md` D-29. This terminology lock is unaffected by this file's supersession; see D-37 for how it applies to the new master.
